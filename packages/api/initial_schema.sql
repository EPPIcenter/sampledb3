...
INSERT INTO schema_version (version) VALUES (7);--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS qpcr_amplification_data_well_result_idx ON qpcr_amplification_data(qpcr_well_result_id);--> statement-breakpoint
