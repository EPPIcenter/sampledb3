      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="storage-card p-6 storage-reveal storage-reveal-2">
          <div className="text-center py-12">
            <svg className="mx-auto h-12 w-12" style={{ color: 'rgb(var(--app-text-muted))' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-6">
              ...
              <ul className="text-sm space-y-2 text-left max-w-md mx-auto" style={{ color: 'rgb(var(--app-text-muted))' }}>
