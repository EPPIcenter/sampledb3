...
export default function BoxDetail() {
  ...
  if (!data?.box) {
    return (
      <div className="storage-page">
        <div className="container mx-auto px-4 py-8 relative z-10">
          <div className="text-center py-8 text-app-trend-down">Box not found</div>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="storage-page">
      ...
      <div className="mb-4 storage-reveal storage-reveal-1">
        ...
        {box.locationPath && (
          <p className="mt-1 text-xs font-mono" style={{ color: 'rgb(var(--app-text-muted))' }}>{box.locationPath}</p>
        )}
      </div>
      ...
      <div className="space-y-4 storage-reveal storage-reveal-3">
        <div className="space-y-3">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {viewMode === 'table' && (
              <div className="flex items-center gap-2">
                <label htmlFor="box-table-column-config" className="text-xs font-medium text-app-text-muted whitespace-nowrap">
                  Columns:
                </label>
                {loadingConfigs ? (
          ...
          {viewMode === 'sheets' && sheets.length === 0 && (
            <p className="text-xs" style={{ color: 'rgb(var(--app-text-muted))' }}>No sheets in this box.</p>
          )}
